          ...
          teammates: [
            {
              ...
              isOwner: true,
              role: '',
              createdAt: new Date(dateFns.addDays(new Date(), 5)).toISOString(),
              updatedAt: '',
            },
            {
              id: '2',
              ...
              isOwner: false,
              role: '',
              createdAt: new Date(dateFns.addDays(new Date(), 4)).toISOString(),
              updatedAt: '',
            },
          ],
          description: '',
        ...
        },
        {
          ...
          teammates: [
            ...
            },
            {
              ...
              isOwner: false,
              role: '',
              createdAt: new Date(dateFns.addDays(new Date(), 3)).toISOString(),
              updatedAt: '',
            },
          ],
          description: '',
