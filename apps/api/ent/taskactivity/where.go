...
func WorkspaceID(v ulid.ID) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDEQ(v ulid.ID) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldWorkspaceID), v))
	})
}
...
func WorkspaceIDNEQ(v ulid.ID) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDIn(vs ...ulid.ID) predicate.TaskActivity {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func WorkspaceIDNotIn(vs ...ulid.ID) predicate.TaskActivity {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func WorkspaceIDGT(v ulid.ID) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDGTE(v ulid.ID) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDLT(v ulid.ID) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDLTE(v ulid.ID) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDContains(v ulid.ID) predicate.TaskActivity {
	vc := string(v)
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDHasPrefix(v ulid.ID) predicate.TaskActivity {
	vc := string(v)
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDHasSuffix(v ulid.ID) predicate.TaskActivity {
	vc := string(v)
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDEqualFold(v ulid.ID) predicate.TaskActivity {
	vc := string(v)
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func WorkspaceIDContainsFold(v ulid.ID) predicate.TaskActivity {
	vc := string(v)
	return predicate.TaskActivity(func(s *sql.Selector) {
...
func HasWorkspace() predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWorkspaceWith(preds ...predicate.Workspace) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTaskActivityTasks() predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTaskActivityTasksWith(preds ...predicate.TaskActivityTask) predicate.TaskActivity {
	return predicate.TaskActivity(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
