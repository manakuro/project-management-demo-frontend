...
func (ftq *FileTypeQuery) FirstID(ctx context.Context) (id ulid.ID, err error) {
	var ids []ulid.ID
...
func (ftq *FileTypeQuery) FirstIDX(ctx context.Context) ulid.ID {
...
func (ftq *FileTypeQuery) OnlyIDX(ctx context.Context) ulid.ID {
...
func (ftq *FileTypeQuery) IDs(ctx context.Context) ([]ulid.ID, error) {
	var ids []ulid.ID
...
func (ftq *FileTypeQuery) IDsX(ctx context.Context) []ulid.ID {
	ids, err := ftq.IDs(ctx)
	if err != nil {
		panic(err)
	}
